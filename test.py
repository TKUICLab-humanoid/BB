...
CORRECT       = [ -1000, 0, 0]        #原地踏步修正
LEFT_CORRECT  = [ -500, -2000, 4]       #左旋修正
RIGHT_CORRECT = [-1300, 1500, -4]       #右旋修正
#                 x , y , theta 
...
FIVE_POINT_LINE  = [3350, 3500, 3650, 4500]        # forward_slow_size < forward_stop_size < backward_stop_size < backward_slow_size 
#注意 size數值調越大會離籃框越近！！！
