...
CORRECT       = [-1600,-400,0]          #原地踏步修正
LEFT_CORRECT  = [-1900,-700,4]          #左旋修正
RIGHT_CORRECT = [-2000,-300,-4]         #右旋修正
#                  x , y , theta 
...
FIVE_POINT_LINE  = [2700,2750,3300] #forward_degree,slow_degree,backward_degree
