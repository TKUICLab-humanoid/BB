...
CATCH_BALL_LINE = [1650, 1550, 1540]            #slow_degree,stop_degree,backward_degree
TWO_POINT_LINE  = [1800, 1700, 1690]            #slow_degree,stop_degree,backward_degree
THREE_POINT_LINE = [2450,  2397,  2335,  2300]     #backward_slow_size, backward_stop_size, forward_stop_size, forward_slow_size
