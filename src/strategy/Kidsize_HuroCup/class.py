...
class motor_move():
    ...
    def body_trace_rotate(self,degree) :
        ...
        if self.x_body_rotate > degree :
            send.sendContinuousValue(left_correct[0],left_correct[1],0,left_correct[2],0)
            print( "go left = ",self.x_body_rotate)
            time.sleep(0.05)
        elif self.x_body_rotate < -degree :
            send.sendContinuousValue(right_correct[0],right_correct[1],0,right_correct[2],0)#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    def body_trace_basket_straight_2(self,basket_size,basket_error) :
        ...
        if target.basket_size - basket_size < -basket_error and  target.basket_size <12000:
            send.sendContinuousValue(2500+correct[0],0+correct[1],0,0+correct[2],0)#!!!!!!!!!!!!!!!
...
if __name__ == '__main__' :
    ...
    throw_ball_point = [2250,800,19500] #灌籃未寫 #16500
    #                   三分  五分  灌籃
    ...
    #           0              1                2           3             4                   5                  6           7             8
    correct = [-600,-500,-5]
    left_correct = [-900,-500,6]
    right_correct = [-700,-500,-8]
     

    # correct = [0,0,0]
   
    #          x,y,theta    
    basket_error = [50,30,550]
    ...
    # ............................................................................................................................
                        ...
                        if step[jmp] == 'open_basket_trace' :
                            ...
                            if target.basket_size < 350 :
                                    ...
                                    motor.view_move(2448,1648,1998,1848,50,0.05)
                                    time.sleep(0.04)
                                    target.basket_parameter()
